...
loo_mw_hapa <- loo(mw_hapa$Model, cores = 20)
...
loo_mw_lapa <- loo(mw_lapa$Model, cores = 20)
...
loo_mw_hana <- loo(mw_hana$Model, cores = 20)
...
loo_mw_lana <- loo(mw_lana$Model, cores = 20)
...
loo_m0_hapa <- loo(m0_hapa$Model, cores = 20)
...
loo_m0_lapa <- loo(m0_lapa$Model, cores = 20)
...
loo_m0_lana <- loo(m0_lana$Model, cores = 20)
