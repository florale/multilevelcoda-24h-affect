...
loo_mw_hapa_lag_adj <- loo(m_hapa_lag_adj$Model, reloo = TRUE, 
...
loo_mw_lapa_lag_adj <- loo(m_lapa_lag_adj$Model, reloo = TRUE, 
                  reloo_args = list(recompile = TRUE, 
                                    future_args = list(globals = list(future.globals.maxSize = 850*1024^2))))
saveRDS(loo_mw_lapa_lag_adj, "loo_mw_lapa_lag_adj.RDS")

loo_mw_hana_lag_adj <- loo(m_hana_lag_adj$Model, reloo = TRUE, 
                  reloo_args = list(recompile = TRUE, 
                                    future_args = list(globals = list(future.globals.maxSize = 850*1024^2))))
saveRDS(loo_mw_hana_lag_adj, "loo_mw_hana_lag_adj.RDS")

loo_mw_lana_lag_adj <- loo(m_lana_lag_adj$Model, reloo = TRUE, 
                  reloo_args = list(recompile = TRUE, 
                                    future_args = list(globals = list(future.globals.maxSize = 850*1024^2))))
saveRDS(loo_mw_lana_lag_adj, "loo_mw_lana_lag_adj.RDS")

loo_m0_hapa_lag_adj <- loo(mb_hapa_lag_adj$Model, reloo = TRUE, 
                   reloo_args = list(recompile = TRUE, 
                                     future_args = list(globals = list(future.globals.maxSize = 850*1024^2))))
saveRDS(loo_m0_hapa_lag_adj, "loo_m0_hapa_lag_adj.RDS")

loo_m0_lapa_lag_adj <- loo(mb_lapa_lag_adj$Model, reloo = TRUE, 
                   reloo_args = list(recompile = TRUE, 
                                     future_args = list(globals = list(future.globals.maxSize = 850*1024^2))))
saveRDS(loo_m0_lapa_lag_adj, "loo_m0_lapa_lag_adj.RDS")

loo_m0_hana_lag_adj <- loo(mb_hana_lag_adj$Model, reloo = TRUE, 
                   reloo_args = list(recompile = TRUE, 
                                     future_args = list(globals = list(future.globals.maxSize = 850*1024^2))))
saveRDS(loo_m0_hana_lag_adj, "loo_m0_hana_lag_adj.RDS")

loo_m0_lana_lag_adj <- loo(mb_lana_lag_adj$Model, reloo = TRUE, 
                   reloo_args = list(recompile = TRUE, 
                                     future_args = list(globals = list(future.globals.maxSize = 850*1024^2))))
